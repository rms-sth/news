...
<div class="wrapper">
  <div class="container">
    <div class="content" id="content-news">
      ...
      <p>Created by: <?php echo $newsdetails[0]['created_by'] .'|' .$newsdetails[0]['created_date']; ?></p>
      <div>
        <?php echo $newsdetails[0]['short_description']; ?>
      </div>
      <div>
        <img src="admin/img/<?php echo $newsdetails[0]['feature_image'] ;?>" width="630px">
      </div>
      <div>
